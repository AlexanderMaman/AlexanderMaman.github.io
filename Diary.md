...
## bsub commands
### Resources:
[IBM guide for the LSF cluster:](https://www.ibm.com/docs/en/spectrum-lsf/10.1.0)
[IBM Documentation-bsub options:](https://www.ibm.com/docs/en/spectrum-lsf/10.1.0?topic=bsub-options)
[Weizmann IT powerpoint :](https://www.weizmann.ac.il/WIT/sites/WIT/files/uploads/it/files/wexac_introduction.pdf)
[WEXAC’s RTM (real-time monitoring of jobs and server loads):](http://rtm.wexac.weizmann.ac.il/)
